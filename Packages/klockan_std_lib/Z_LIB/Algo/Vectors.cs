...
public static class VectorOverloads {
   ...
   public static int2 int2(this Vector2Int p) => new int2(p.x, p.y);
...
public struct int2 {
   ...
   public static int2 operator -(int2 o) => new int2(-o.x, -o.y);
   ...
   public static int2 operator *(int a, int2 b) {
      return new int2 { x = a * b.x, y = a * b.y };
   }
   [MethodImpl(AggressiveInlining)]
   public static int2 operator *(int2 a, int b) {
      return new int2 { x = a.x * b, y = a.y * b };
   }
   [MethodImpl(AggressiveInlining)]
   public static float2 operator *(float a, int2 b) {
      return new float2 { x = a * b.x, y = a * b.y };
   }
   [MethodImpl(AggressiveInlining)]
   ...
   [MethodImpl(AggressiveInlining)] public static implicit operator int2(Vector2Int a) => new int2(a.x, a.y);
   public static implicit operator Vector2Int(int2 a) => new Vector2Int(a.x, a.y);
   
   [MethodImpl(AggressiveInlining)] public static implicit operator Unity.Mathematics.int2(int2 a) => new (a.x, a.y);
