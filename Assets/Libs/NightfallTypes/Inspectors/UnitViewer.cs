         ...
         get {
            if (unit.Weapon_Primary) {
               ...
               if (w.IsRanged) {
                  ...
                  yield return new(w.name.Replace("_", " "), $"{w.Attack + unit.Attack} att    {w.Damage + unit.Strength}d");
               }
            }
      ...
      public IEnumerable<KeyVal> armor_stats {
         get {
            ...
            if (unit.shield) {
               ...
               yield return new(unit.shield.name.Replace("_", " "), $"{enc}{unit.shield.Parry} parry    {unit.shield.Shield_Protection} prot");
            }
            if (unit.helmet) {
